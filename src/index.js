document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    progressBar.style.width = `${num}%`; // This value is hardcoded as a placeholder
    ...
    question.choices.forEach((element) => {
      const choiceButtons = document.createElement("input");
      choiceButtons.setAttribute("type", "radio");
      choiceButtons.setAttribute("name", "choice");
      choiceButtons.setAttribute("value", `${element}`);
      const buttonLabel = document.createElement("label");
      buttonLabel.textContent = `${element}`;
      choiceContainer.appendChild(choiceButtons);
      choiceContainer.appendChild(buttonLabel);
